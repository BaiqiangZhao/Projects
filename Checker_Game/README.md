# WI22-Assignment6
### Due Mar 14, 2022 @ 11:30pm

## Let's Play Checkers

In the previous assignment, you designed your own Game class for the Checkers game. In this assignment, we have provided you with a complete working version of the Game class. The focus of this assignment is for you to implement the logic of your player. Before we go to the core implementation, your first task is a compare and contrast of your design and our design of the Game class. 

### Task 1: Game Class Design Compare & Contrast

For this task, you are required to review the provided Game class design and compare all design elements to your own design that you had submitted in your previous assignment. You can submit this comparision in a format of your choice. One way to present this could be a table where the first column lists the design element, second column discusses your idea for this design element, and the third column discusses how we implemented it. 
...
In this challenge, you will implement a "checker-bot" class that competes in a game of Checkers. During the course of play, your checker-bot will be given alternating "turns" to move one game piece on the board. Gameplay will continue until a terminal condition occurs:
...
We are also setting up a server where you can upload your code to so that our script reads your code and runs it against all other submissions automatically. Scores are then updated and available for you to review on Slidespace. More information on this cool feature to come soon...

## Submitting your work - Due March 14, 11:30pm (PST)
...
> NOTE: Don't forget to fill out your students.json file with your name. Also -- make sure to submit your work to github as usual.
